					...
					<div class="box-body">
						<div class="row">
							...
							<div class="col-md-8 col-sm-6">
								<h1 class="box-title mt-0" data-sider-select-id="b6bb582b-b249-43e0-869f-d6be96db9449"><?php echo $mesa[0]["Descripcion"] ?></h1>
								<?php 
								$categoria = $this->CategoriaMesasModel->DevolverDescripcionCategoriaMesa($mesa[0]["Id_Categorias_mesa"]); 
								 echo'<h4 class="pro-price mb-0 mt-20">Categoria: '. $categoria.'</h4>';
								?>
								<h4 class="pro-price mb-0 mt-20">Valor de la reservación: $<?php echo $mesa[0]["Valor_Agregado"] ?></h4>
							
								<hr>
								<div class="gap-items">
									
									<?php 
									echo '<a href="'. base_url("index.php/Pagar/null").'" class="btn btn-primary">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<h4 class="box-title mt-40">Informacion del Cliente</h4>
